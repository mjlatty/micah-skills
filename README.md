...
| `plan-docs` | Turns an agreed plan into a file the project keeps, and sorts `plans/` into draft/ready/in-progress/done by what the repo shows rather than what the plan claims |
